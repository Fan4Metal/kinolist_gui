...
class InfoPanel(wx.Dialog): 
    def __init__(self, parent, title, id): 
        ...
        self.l_search3 = wx.TextCtrl(self.panel, value = filminfo[4] if filminfo[4] else "Нет описания",
...
class MyFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.gauge = wx.Gauge(self.statusbar, range = 100,
                                pos = (self.FromDIP(91), self.FromDIP(2)), size = self.FromDIP((self.statusbar.GetSize()[0] - 72, 20)),
